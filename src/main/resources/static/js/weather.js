$.get("https://api.openweathermap.org/data/2.5/onecall", {
    ...
    data.daily.forEach(function (dailyWeather, index) {
        ...
        let currentDay = new Date(dailyWeather.sunrise * 1000).toLocaleDateString('en', {weekday:'long'});
        ...
        $("#weather-cards").append(
            '<div class="card" style="background: black; border-radius: 0; border-color: #f4cdc1; width: 175px; padding: 0;">' +
            ...
            '<div class="card-body d-flex justify-content-center" style="padding: 0; height: 75px;">' +
                ...
                '<div class="card-text" style="color: #f4cdc1; height: 75px;">' + dailyWeather.temp.min.toFixed() + "°F" + " - " + dailyWeather.temp.max.toFixed() + "°F" + '</div>' +
            '</div>' +
            '</div>');
    });
});
